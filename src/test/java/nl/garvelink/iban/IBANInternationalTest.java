...
public class IBANInternationalTest {
    ...
    /**
     * List of valid international IBAN's obtained from http://www.ecbs.org/iban.htm and
    ...
    public static List<String[]> parameters() {
        return Arrays.asList(
            str( "Albania",                  "AL47212110090000000235698741",    "AL47 2121 1009 0000 0002 3569 8741"),
            str( "Algeria",                  "DZ4000400174401001050486",        "DZ40 0040 0174 4010 0105 0486"),
            str( "Andorra",                  "AD1200012030200359100100",        "AD12 0001 2030 2003 5910 0100" ),
            str( "Angola",                   "AO06000600000100037131174",       "AO06 0006 0000 0100 0371 3117 4"),
            str( "Austria",                  "AT611904300234573201",            "AT61 1904 3002 3457 3201" ),
            str( "Azerbaijan",               "AZ21NABZ00000000137010001944",    "AZ21 NABZ 0000 0000 1370 1000 1944"),
            str( "Bahrein",                  "BH29BMAG1299123456BH00",          "BH29 BMAG 1299 1234 56BH 00"),
            str( "Belgium",                  "BE68539007547034",                "BE68 5390 0754 7034" ),
            str( "Benin",                    "BJ11B00610100400271101192591",    "BJ11 B006 1010 0400 2711 0119 2591"),
            str( "Bosnia and Herzegovinia",  "BA391290079401028494",            "BA39 1290 0794 0102 8494" ),
            str( "Brazil",                   "BR9700360305000010009795493P1",   "BR97 0036 0305 0000 1000 9795 493P 1"),
            str( "Bulgaria",                 "BG80BNBG96611020345678",          "BG80 BNBG 9661 1020 3456 78" ),
            str( "Burkina Faso",             "BF1030134020015400945000643",     "BF10 3013 4020 0154 0094 5000 643"),
            str( "Burundi",                  "BI43201011067444",                "BI43 2010 1106 7444"),
            str( "Cameroon",                 "CM2110003001000500000605306",     "CM21 1000 3001 0005 0000 0605 306"),
            str( "Cape Verde",               "CV64000300004547069110176",       "CV64 0003 0000 4547 0691 1017 6"),
            str( "Congo",                    "CG5230011000202151234567890",     "CG52 3001 1000 2021 5123 4567 890"),
            str( "Costa Rica",               "CR0515202001026284066",           "CR05 1520 2001 0262 8406 6"),
            ...
            str( "Dominican Republic",       "DO28BAGR00000001212453611324",    "DO28 BAGR 0000 0001 2124 5361 1324"),
            str( "Egypt",                    "EG1100006001880800100014553",     "EG11 0000 6001 8808 0010 0014 553" ),
            str( "Estonia",                  "EE382200221020145685",            "EE38 2200 2210 2014 5685" ),
            str( "Faroe Islands",            "FO1464600009692713",              "FO14 6460 0009 6927 13" ),
            ...
            str( "Gabon",                    "GA2140002000055602673300064",     "GA21 4000 2000 0556 0267 3300 064"),
            str( "Georgia",                  "GE29NB0000000101904917",          "GE29 NB00 0000 0101 9049 17"),
            ...
            str( "Greenland",                "GL8964710001000206",              "GL89 6471 0001 0002 06"),
            str( "Guatemala",                "GT82TRAJ01020000001210029690",    "GT82 TRAJ 0102 0000 0012 1002 9690"),
            ...
            str( "Iran",                     "IR580540105180021273113007",      "IR58 0540 1051 8002 1273 1130 07"),
            ...
            str( "Ivory Coast",              "CI05A00060174100178530011852",    "CI05 A000 6017 4100 1785 3001 1852"),
            str( "Kazakhstan",               "KZ176010251000042993",            "KZ17 6010 2510 0004 2993"),
            str( "Kuwait",                   "KW74NBOK0000000000001000372151",  "KW74 NBOK 0000 0000 0000 1000 3721 51"),
            str( "Latvia",                   "LV80BANK0000435195001",           "LV80 BANK 0000 4351 9500 1" ),
            str( "Lebanon",                  "LB30099900000001001925579115",    "LB30 0999 0000 0001 0019 2557 9115"),
            ...
            str( "Madagascar",               "MG4600005030010101914016056",     "MG46 0000 5030 0101 0191 4016 056"),
            str( "Mali",                     "ML03D00890170001002120000447",    "ML03 D008 9017 0001 0021 2000 0447"),
            str( "Malta",                    "MT84MALT011000012345MTLCAST001S", "MT84 MALT 0110 0001 2345 MTLC AST0 01S" ),
            str( "Mauritania",               "MR1300012000010000002037372",     "MR13 0001 2000 0100 0000 2037 372"),
            str( "Mauritius",                "MU17BOMM0101101030300200000MUR",  "MU17 BOMM 0101 1010 3030 0200 000M UR" ),
            str( "Moldova",                  "MD24AG000225100013104168",        "MD24 AG00 0225 1000 1310 4168"),
            ...
            str( "Mozambique",               "MZ59000100000011834194157",       "MZ59 0001 0000 0011 8341 9415 7"),
            str( "Netherlands",              "NL91ABNA0417164300",              "NL91 ABNA 0417 1643 00" ),
            str( "Norway",                   "NO9386011117947",                 "NO93 8601 1117 947" ),
            str( "Pakistan",                 "PK24SCBL0000001171495101",        "PK24 SCBL 0000 0011 7149 5101"),
            str( "Palistinian Territories",  "PS92PALS000000000400123456702",   "PS92 PALS 0000 0000 0400 1234 5670 2"),
            ...
            str( "Saudi Arabia",             "SA0380000000608010167519",        "SA03 8000 0000 6080 1016 7519"),
            str( "Senegal",                  "SN12K00100152000025690007542",    "SN12 K001 0015 2000 0256 9000 7542"),
            str( "Serbia",                   "RS35260005601001611379",          "RS35 2600 0560 1001 6113 79" ),
            str( "Slovakia",                 "SK3112000000198742637541",        "SK31 1200 0000 1987 4263 7541" ),
            ...
            str( "Tunisia",                  "TN5914207207100707129648",        "TN59 1420 7207 1007 0712 9648"),
            str( "Turkey",                   "TR330006100519786457841326",      "TR33 0006 1005 1978 6457 8413 26" ),
            str( "Ukraine",                  "UA573543470006762462054925026",   "UA57 3543 4700 0676 2462 0549 2502 6"),
            str( "United Arab Emirates",     "AE260211000000230064016",         "AE26 0211 0000 0023 0064 016"),
            str( "United Kingdom",           "GB29NWBK60161331926819",          "GB29 NWBK 6016 1331 9268 19" ),
            str( "Virgin Islands, British",  "VG96VPVG0000012345678901",        "VG96 VPVG 0000 0123 4567 8901")
        );
    }
